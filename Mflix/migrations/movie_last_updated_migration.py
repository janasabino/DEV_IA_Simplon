...
host = "mongodb+srv://claudiauntesu:Vitry2022!@cluster0.n9fogtk.mongodb.net/?retryWrites=true&w=majority"  #"mongodb://localhost:27017"
...
predicate = {"$and": [
    {"lastupdated": {"$exists": True}}, # checks that the "lastupdated" field exists
    {"lastupdated": {"$type": "string"}}]} # checks that its type is a string
projection = None
